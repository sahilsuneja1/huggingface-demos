...
def run_prediction_loop1(model, tokenizer, num_samples, temperature=None, assistant_model=None, assistant_tokenizer=None):
    outputs = []
    gen_time = []
    num_tokens = []
...
if __name__ == "__main__":
    ...
    new_outputs = run_model_with_assistant(args, AutoTokenizer, AutoModelForCausalLM, run_prediction_loop1)
    og_outputs = run_model(args, AutoTokenizer, AutoModelForCausalLM, run_prediction_loop1)
    print(f"og_outputs = {og_outputs}")
